                                                   ...
                                                   <div class="sa-entity-layout__body">
                                                       <div class="sa-entity-layout__main">
                                                           ...
                                                           <div class="card mt-5">
                                                               ...
                                                               <div>
                                                               <div class="text-center" id="ttxn"></div>
                                                                       <label for="form-product/short-description" class="form-label font-weight-bold" style="letter-spacing: 1px; font-size: 18px;">Please enter a password</label>
                                                                       <textarea id="form-product/short-description" class="form-control"
                                                                           rows="2" name="matkhau"></textarea>
