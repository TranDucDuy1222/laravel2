      ...
      <div class="container">
        <div class="menu-init">
          ...
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
            ...
            <li class="nav-item"> <router-link class="nav-link fz" to="/loai-san-pham/tat-ca-san-pham"> Mới và Nổi Bật </router-link> 
          </li> 
          @yield('category') 
          <li class="nav-item"> 
              <router-link class="nav-link fz" to="/loai-san-pham/giam-gia"> Giảm Giá </router-link> </li>
            </ul>
          </div>
        </div>
        <div class="menu-init">
          ...
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample3"
            ...
            <li><a class="dropdown-item" href="{{ route('user.profile', [Auth::user()->id]) }}">Quản Lý Tài
              Khoản</a></li>
            <hr>
            <li><a class="dropdown-item" href="{{ route('user.purchase', [Auth::user()->id]) }}">Đơn Hàng Đã Mua</a></li>
            <hr>
