...
<div class="container">
    <div class="row" style="border: 1px solid #DCDCDC; height: 70vh;">
        <div class="col-3 bg-body-secondary">
            <ul class="list-unstyled">
                ...
                <li class="bg-body-secondary"><button type="submit" style="border: none;"><a class="text-decoration-none text-dark dropdown-dc mt-2 h6"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                ...
                                <form action="{{ route('diachi.add', [Auth::user()->id]) }}" method="post" @submit.prevent="submitForm">
    @csrf 
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputName" name="ho_ten" v-model="ho_ten">
        </div>
        <div class="form-group">
            <label for="inputPhone">Số điện thoại</label>
            <input type="phone" class="form-control" id="inputPhone" name="phone" v-model="phone">
        </div>
        <div id="appAddDC">
            <address-form @update-address="updateAddress"></address-form>
        </div>
        <input type="hidden" name="tinhtp" :value="tinhtp ? tinhtp.Name : ''">
        <input type="hidden" name="quanhuyen" :value="quanhuyen ? quanhuyen.Name : ''">
        <input type="hidden" name="phuongxa" :value="phuongxa ? phuongxa.Name : ''">
    </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-link" style="background: none; border: none; padding: 0; color: blue; text-decoration: underline; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $dc->id }}">Cập nhật</button>
