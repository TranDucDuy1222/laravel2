    ...
    <div class="mx-xl-5 mt-2 row">
                ...
                <div class="accordion-item">
                    ...
                    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
                        <div class="accordion-body row">
                            ...
                            <div class="col-lg-4">
                                <button class="rounded-circle border border-white bg-light"
                                    style="height: 40px; width: 40px;"></button>
                                <p>Trắng</p>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <button class="rounded-circle border bgpink"
                                    style="height: 40px; width: 40px;"></button>
                                <p>Hồng</p>
                            </div>
                            <div class="col-lg-4">
        ...
        <div class="col-lg-10">
            ...
            <div class="row">
                ...
                @php
                    $giachinh = number_format($item->giakhuyenmai, 0, '', '.');
                @endphp
                    <div class="col-sm-6 col-xl-3 mb-2">
                        <div class="card position-relative">
                            <img src="/imgnew/sale.png" style="width: 70px; height: 70px;" class="z-1 position-absolute " alt="">
            ...
            <!-- Phân trang -->
            <div class="p-2 d-flex justify-content-center"> {{$sale->links()}} </div>
