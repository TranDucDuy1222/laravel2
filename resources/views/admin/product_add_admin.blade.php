                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col">
                                            ...
                                            <input class="form-control my-2" readonly value="37" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <label for="form-product/quantity" class="form-label">Số lượng</label>
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    </div>
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="38.5" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="39" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="39.5" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="40" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="40.5" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="41" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="41.5" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="42" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col">
                                            <input class="form-control my-2" readonly value="42.5" name="size_product[]" />
                                        </div>
                                        <div class="col">
                                            <input value="  {{old('so_luong[]')}}" type="number" class="form-control my-2" name="so_luong[]" required />
                                        </div>
