                              ...
                              <div class="form-card text-left">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" disabled readonly value="37" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="38.5" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="39" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="39.5" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="40" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="40.5" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="41" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="41.5" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="42" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="43.5" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="43" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <label for="form-product/size" class="form-label fw-semibold">Kích thước</label>
                                          <input class="form-control" disabled readonly value="S" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="M" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="L" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
                                          <input class="form-control" disabled readonly value="XL" name="size_product[]" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                       <div class="form-group">
