               ...
               <div class="iq-card-body">
                  <div class="table-responsive">
                     <div class="card-body">
                        ...
                        @if ($donHang->trang_thai != 1 && $donHang->trang_thai != 3 && $donHang->trang_thai != 4 && $donHang->trang_thai != 5)
                                 ...
                                 <div class="col-md-2 mb-3" >
                                    <select name="trang_thai" id="trang_thai" class="form-control">
                                       @if ($donHang->trang_thai == 2)
                                          <option value="5" {{ $donHang->trang_thai == '5' ? 'selected' : '' }}>Người nhận không lấy hàng</option>
                                       @elseif($donHang->trang_thai == 0)
