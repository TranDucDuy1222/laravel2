...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
            <button type="button" class="btn btn-primary" id="continueButton">Tiếp tục <i class="fa-solid fa-arrow-right fa-beat"></i></button>
         </div>
         <script>
            document.getElementById('continueButton').addEventListener('click', function() {
               var selectedValue = document.getElementById('selectLoai').value;
               window.location.href = "{{ route('san-pham.create') }}" + "?selection=" + selectedValue;
            });
         </script>
      </div>
   </div>
